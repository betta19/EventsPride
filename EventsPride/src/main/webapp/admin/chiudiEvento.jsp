...
<body class="bg-light">
	...
	<table class="table table-dark">
		...
		<c:forEach items="${listaEventi}" var="evento">
			...
			<tr>
				...
				<td><c:out value="${evento.getListaUtenti().size()}" /></td>
				<td><img alt="immagine"
	...
	<td>	<c:if test="${n>1}">		<form action="chiudiEvento" method="post"><select name="numero">
						...
						<button type="submit" class="btn btn-warning" name="idEvento"
							value=<c:out value = "${evento.getId()}"/>>Chiudi evento
						</button>
